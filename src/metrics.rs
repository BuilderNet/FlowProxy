...
pub(crate) struct IngressMetrics {
    ...
    #[metric(rename = "rpc_latency_oneway_seconds", labels = ["source", "method"], buckets = [0.0001, 0.00025, 0.0005, 0.00075, 0.001, 0.0025, 0.005, 0.010, 0.020, 0.050, 0.100, 0.200, 0.500, 1.0, 2.0])]
